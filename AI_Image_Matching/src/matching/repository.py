...
from db.models import AiCallLog, Image, ImageMetadata, ImageVector, Post, PostVector, ReviewDecision, Suggestion

REVIEW_CONFIDENCE_THRESHOLD = 0.75

def persist_ai_call(session: Session, rec: dict) -> AiCallLog:
    """Write one AI-call record (see telemetry.call_logger) to ai_call_log."""
    row = AiCallLog(
